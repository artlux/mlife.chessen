...
function trashDraggedPiece() {
  ...
  draggedPieceEl.hide(cfg.trashSpeed);
...
function dropDraggedPieceOnSquare(square) {
 ...
 // $$(draggedPieceEl).css(targetSquarePosition);
...
function mousedownSquare(e) {
  ...
  //if($$(e.target).attr('data-piece') && DRAGGED_PIECE != $$(e.target).attr('data-piece')) return;
...
function addEvents() {
  ...
  //$$(document).off('click', '.' + CSS.piece, stopDefault);
  $$(document).on('click', '.' + CSS.piece, stopDefault);
  
  //boardEl.off('click', '.' + CSS.square, mousedownSquare);
  boardEl.on('click', '.' + CSS.square, mousedownSquare);
 // containerEl.on('click', '.' + CSS.sparePieces + ' .' + CSS.piece,
 //   mousedownSparePiece);
