window._lang_default = {
	...
	ERRSQL:'Error loading page from database',
	ERR2:'Template not found, maybe an error occurred while loading data. Check your Internet connection and try again',
	ERR3:'Connection error',
	LOADING:'Loading is complete',
	LOAD:'Download data',
	LOAD1:'This is the first application launch. Wait for the data to load.',
	LOAD2:'This is the first application launch. Connect to the Internet and download data.',
	ERRCN:'No connection, download canceled',
	ALERT:'Notification',
};
...
window.debug = false;
window.startUrl = 'https://redkovka.by/chess_app/en/';
...
if(typeof(window.openDatabase) !== 'undefined'){
	db = window.openDatabase('mlifechessen.db','1.0','mlifechessen',1*1024*1024);
}else{
	db = window.sqlitePlugin.openDatabase({name: 'mlifechessen',location: 'default'},function(db){});
}
